...
namespace PlayOfferService.Migrations.DbRead
{
    ...
    [Migration("20240529075732_RefactorIsLockedToStatus")]
    partial class RefactorIsLockedToStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlayOfferService.Models.PlayOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3655e6cd-5d91-44f9-8b0c-9548a06b6762"),
                            ClubId = new Guid("06b812a7-5131-4510-82ff-bffac33e0f3e"),
                            CreatorId = new Guid("40c0981d-e2f8-4af3-ae6c-17f79f3ba8c2"),
                            IsCancelled = false,
                            ProposedEndTime = new DateTime(2024, 5, 29, 8, 57, 31, 906, DateTimeKind.Utc).AddTicks(4438),
                            ProposedStartTime = new DateTime(2024, 5, 29, 7, 57, 31, 906, DateTimeKind.Utc).AddTicks(4436)
                        });
                });
