...
namespace PlayOfferService.Migrations
{
    ...
    [Migration("20240622092733_ReservationChangedCourtId")]
    partial class ReservationChangedCourtId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlayOfferService.Domain.Models.PlayOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a4e3d4e5-5215-4094-a333-ce3ee8154675"),
                            ClubId = new Guid("06b812a7-5131-4510-82ff-bffac33e0f3e"),
                            CreatorId = new Guid("40c0981d-e2f8-4af3-ae6c-17f79f3ba8c2"),
                            IsCancelled = false,
                            ProposedEndTime = new DateTime(2024, 6, 22, 10, 27, 32, 806, DateTimeKind.Utc).AddTicks(9696),
                            ProposedStartTime = new DateTime(2024, 6, 22, 9, 27, 32, 806, DateTimeKind.Utc).AddTicks(9693)
                        });
                });
