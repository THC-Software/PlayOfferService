...
namespace PlayOfferService.Migrations
{
    ...
    [Migration("20240607112446_memberExpansion")]
    partial class memberExpansion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlayOfferService.Domain.Models.PlayOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7d079edb-d4c8-4e63-9c5b-35b80eaa69f6"),
                            ClubId = new Guid("06b812a7-5131-4510-82ff-bffac33e0f3e"),
                            CreatorId = new Guid("40c0981d-e2f8-4af3-ae6c-17f79f3ba8c2"),
                            IsCancelled = false,
                            ProposedEndTime = new DateTime(2024, 6, 7, 12, 24, 44, 893, DateTimeKind.Utc).AddTicks(6493),
                            ProposedStartTime = new DateTime(2024, 6, 7, 11, 24, 44, 893, DateTimeKind.Utc).AddTicks(6491)
                        });
                });
